...
Copied & edited from Ciastkolog.pl (https://github.com/ciastkolog) by Yazar Yazici
...
bmp280_read_float(&bmp280, &temperature, &pressure, &humidity, &altitude);  // okuma
...
#define BMP280_CHIP_ID  0x60 /* BMP280 has chip-id 0x58 */
#define BME280_CHIP_ID  0x58 /* BME280 has chip-id 0x60 */
